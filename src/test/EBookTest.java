...
class EBookTest{
    ...
    @BeforeEach
    void setUp() {
        eBook1 = new EBook("1984", "George Orwell", "1234567890", models.FileFormat.PDF);
        eBook2 = new EBook("The Great Gatsby", "F. Scott Fitzgerald", models.FileFormat.EPUB);
        eBook3 = new EBook("Moby Dick", "Herman Melville", "1122334455", models.FileFormat.MOBI);
        eBook4 = new EBook("War and Peace", "Leo Tolstoy", models.FileFormat.AZW);
    }
